...
export const UpdateVenueMonitorModal = ({
  onSubmit,
  getInProgress,
  getFailed,
  initialValues,
  ...
  return (
    <ModalContainer title='Edit Venue Monitor' type='wide' onHide={onHide}>
...
UpdateVenueMonitorModal.propTypes = {
...
export default connect(state => ({
  initialValues: state.venueMonitorForEdit.venueMonitor,
  getInProgress: state.venueMonitorForEdit.getInProgress,
  getFailed: state.venueMonitorForEdit.getFailed
