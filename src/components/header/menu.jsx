...
class Menu extends React.Component {
  ...
  _componentHasFocus () {
    return document.activeElement === ReactDOM.findDOMNode(this.header)
  }
  _getOverlayTarget = () => {
    return ReactDOM.findDOMNode(this.header)
  }
  _closeMenu () {
    this.setState({ isOpen: false, selectedIndex: null })
  }
  ...
  render () {
    ...
    return (
      <div styleName='container' ref={ref => (this.container = ref)}>
        <HeaderButton
